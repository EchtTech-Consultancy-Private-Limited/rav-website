			...
			columnDefs: [
				{
					...
					render: function(data, type, full, meta) {
						...
						if (crudUrlTemplate.view !== undefined) {
							viewLinkHtml = '<a href="' + crudUrlTemplate.view.replace("xxxx", full.id) + 
						...
						if (crudUrlTemplate.edit !== undefined) {
							editLinkHtml = '<a href="'+ crudUrlTemplate.edit.replace("xxxx", full.id) +'" class="btn btn-sm btn-clean btn-icon mr-2 track-click"\
						...
						if (crudUrlTemplate.delete !== undefined) {
							deleteLinkHtml = '<a href="'+ crudUrlTemplate.delete.replace("xxxx", full.id) +'" class="btn btn-sm btn-clean btn-icon delete-single-record track-click"\
				...
				},
				{
					...
					render: function (data, type, full, meta) {
						...
						{
							var url_publisher = crudUrlTemplate.publisher.replace("xxxx", full.uid || full.id)
						...
						{
							var url_approver = crudUrlTemplate.approver.replace("xxxx", full.uid || full.id)
