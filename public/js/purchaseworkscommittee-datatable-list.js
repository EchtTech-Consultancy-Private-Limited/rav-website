...
var KTDatatablesBasicPaginations = function() {
	var initTable1 = function() {
		var table = $('#kt_datatable_purchaseworkscommittee');
		var $i=1;
		...
		var tableObject = table.DataTable({
			...
			columns: [
				{ "data": "uid" },
				{ "data": "name_of_supplier_party_en" },
				{ "data": "quality_supplied_en" },
				{ "data": "order_contract_no" },
				{ "data": "amount" },
				{ "data": "public_url" },
				{ "data": "status" },
				{ "data": "action" }
							...
							return '<span style="width: 250px;">\
								<div class="d-flex align-items-center">\
									<div class="symbol symbol-40 symbol-sm flex-shrink-0">\
										<a class="" target="_blank" href="'+'../resources/uploads/purchaseworkscommittee/'+full.public_url+'" alt="photo">Download</a>\
									</div>\
								</div>\
							</span>';
						}
