var KTAppNewSectionsSave = function () {
    ...
    var validation;
    var form = document.getElementById('kt_newSection_update_form');
                   ...
                   if (response) {
                     ...
                     $('#loading-content').removeClass('loading-content');
                      ...
                      setTimeout(function() {
                        ...
                        location.href = 'newsection-edit?id='+id // reload page
                      }, 1500);
 ...
 return {
         init: function () {
             demos();
             _officeAdd = $('#kt_newSection_update_form');
             _handleOfficeAddForm();
             submitButton = document.querySelector('#kt_update_newSection_submit');
             // Handle forms
         }
     };
 }();
