var KTApphomepagesectiondesignSave = function () {
    ...
    var id = new URLSearchParams(window.location.search).get('id');
     ...
     var validation;
     var form = document.getElementById('kt_homepagesectiondesign_update_form');
                    ...
                    if (response) {
                      ...
                      $('#loading-content').removeClass('loading-content');
                       ...
                       setTimeout(function() {
                          ...
                          location.href = 'homepagesection-list'; // reload page
                       }, 1500);
  ...
  return {
          init: function () {
              demos();
              _officeAdd = $('#kt_homepagesectiondesign_update_form');
              _handleOfficeAddForm();
              submitButton = document.querySelector('#kt_update_homepagesectiondesign_submit');
              // Handle forms
          }
      };
  }();
  ...
  jQuery(document).ready(function() {
     KTApphomepagesectiondesignSave.init();
  });