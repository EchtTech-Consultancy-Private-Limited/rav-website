var KTAppNewsSave = function () {
    ...
    var validation;
    var form = document.getElementById('kt_news_add_form');
       ...
       $('.submit-news-btn').click( function(e) {
             e.preventDefault();
             validation.validate().then(function(status) {
                ...
                axios.post(crudUrlTemplate.create_news,
                            formData, {
                   ...
                   if (response) {
                     ...
                     $('#loading-content').removeClass('loading-content');
                      ...
                      setTimeout(function() {
                         ...
                         location.href = 'news-create'; // reload page
                      }, 1500);
 ...
 return {
         init: function () {
             demos();
             initFormRepeater();
             _officeAdd = $('#kt_news_add_form');
             _handleOfficeAddForm();
             submitButton = document.querySelector('#kt_add_news_submit');
             // Handle forms
         }
     };
 }();
