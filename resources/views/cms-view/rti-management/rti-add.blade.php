...
@endsection
@push('post-scripts')
<script src="{{ asset('public/form-js/rti-add.js') }}"></script>
@endpush
@section('content')
...
<div class="card card-flush">
   ...
   <div class="card-body">
      <!--begin::Form-->
      <form id="kt_rti_add_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
         <!--begin::Main column-->
         <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="d-flex justify-content-end">
               ...
               <!--end::Button-->
               <!--begin::Button-->
               <button type="submit" id="kt_add_rti_submit" class="btn btn-primary submit-rti-btn">
