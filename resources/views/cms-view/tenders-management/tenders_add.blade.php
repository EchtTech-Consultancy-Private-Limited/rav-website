                        ...
                        <div class="card-body pt-0">
                           ...
                           <div class="fv-row mb-10">
                              <div class="row g-9 mb-7">
                                 ...
                                 <div class="col-md-3 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" type="datetime-local" placeholder="" name="openingdate" value="" />
                                    <!--end::Input-->
                                 </div>
                                 <!--end::Col-->
                              </div>
                           ...
                           <div class="fv-row mb-10">
                              <div class="row g-9 mb-7">
                                 ...
                                 <div class="col-md-3 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid tender_cost" type="number" id="tender_cost" placeholder="" name="tender_cost" value="" />
                                    <!--end::Input-->
                                 </div>
                                 <!--end::Col-->
                                 @endif
                           ...
                           @endif
                            ...
                            <div class="mb-10 fv-row">
                              ...
                              <!--begin::Input-->
                              <div class="col-md-12">
                                 <input type="url" name="applyurl" class="form-control mb-2 applyurl" id="applyurl" placeholder="Apply URL.." value="" />
                              </div>
                              <!--end::Input-->
                              <!--begin::Description-->
                           ...
                           <div class="mb-10 fv-row">
                              ...
                              <!--begin::Input-->
                              <div class="col-md-12">
                                 <input type="text" name="title_name_en" class="form-control mb-2 title_name_en" id="title_name_en" placeholder="{{config('FormField.placeholder_title_en')}}" value="" />
                              </div>
                              <!--end::Input-->
                              <!--begin::Description-->
                              <div class="text-muted fs-7">A title name is required and recommended to be unique.</div>
                           ...
                           <div class="mb-10 fv-row mt-2">
                              ...
                              <!--end::Label-->
                              <!--begin::Input-->
                              <input type="text" name="title_name_hi" class="form-control mb-2 title_name_hi" id="title_name_hi" placeholder="{{config('FormField.placeholder_title_hi')}}" value="" />
                              <!--end::Input-->
                              <!--begin::Description-->
                              <div class="text-muted fs-7">A title name is required and recommended to be unique.</div>
                              <!--end::Description-->
                                    ...
                                    <div data-repeater-list="kt_tender_add_multiple_options" class="d-flex flex-column gap-3">
                                       <div data-repeater-item class="form-group d-flex flex-wrap align-items-center gap-5">
                                          ...
                                          <!-- <div>
                                             ...
                                             <input type="datetime" class="form-control mw-100 w-200px" name="openingdate" />
                                          </div> -->
                                          <!-- <div>
