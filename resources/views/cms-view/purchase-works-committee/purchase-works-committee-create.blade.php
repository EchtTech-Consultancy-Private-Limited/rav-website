...
@section('title')
    {{__('Purchase Works Committee Create')}}
@endsection
@section('pageTitle')
...
@endsection
@push('post-scripts')
<script src="{{ asset('public/form-js/purchaseworkscommittee-add.js') }}"></script>
@endpush
@section('content')
...
<div id="kt_content_container" class="container-xxl">
   ...
   <div class="card-body">
   <!--begin::Form-->
   <form id="kt_purchaseworkscommittee_add_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
      <!--begin::Main column-->
      <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="fv-row mb-10">
                           <div class="row g-9 mb-7">
                              ...
                              <div class="col-md-3 fv-row">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input class="form-control form-control-solid" type="text" placeholder="Order/Contract No" name="order_contract_no" value="" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Col-->
                              <!--begin::Col-->
                              <div class="col-md-3 fv-row">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input class="form-control form-control-solid" type="text" placeholder="Amount (Rs)" name="amount" value="" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Col-->
                              <!--begin::Col-->
                        ...
                        <div class="fv-row mb-10">
                           <div class="row g-9 mb-7">
                              ...
                              <div class="col-md-12 fv-row">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" name="title_name_hi" id="title_name_hi" class="form-control mb-2 title_name_hi" id="title_name_hi" placeholder="शीर्षक (हिन्दी में)" value="" />
                                 <!--end::Input-->
                              </div>
                              <!--begin::Col-->
                              <div class="col-md-6 fv-row">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" name="name_of_supplier_party_en" id="name_of_supplier_party_en" class="form-control mb-2 name_of_supplier_party_en" id="name_of_supplier_party_en" placeholder="Name of Supplier/Party" value="" />
                                 <!--end::Input-->
                              </div>
                              <div class="col-md-6 fv-row">
                                 <!--begin::Label-->
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" name="name_of_supplier_party_hi" id="name_of_supplier_party_hi" class="form-control mb-2 name_of_supplier_party_hi" id="name_of_supplier_party_hi" placeholder="आपूर्तिकर्ता/पार्टी का नाम" value="" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Col-->
                           </div>
                        ...
                        <div class="fv-row mb-10">
                           <div class="row g-9 mb-7">
                              ...
                              <div class="col-md-6 fv-row">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" name="quality_supplied_en" id="quality_supplied_en" class="form-control mb-2 quality_supplied_en" id="title_name_en" placeholder="Quality Supplied" value="" />
                                 <!--end::Input-->
                              </div>
                              <div class="col-md-6 fv-row">
                                 <!--begin::Label-->
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" name="quality_supplied_hi" id="quality_supplied_hi" class="form-control mb-2 quality_supplied_hi" id="quality_supplied_hi" placeholder="गुणवत्ता की आपूर्ति" value="" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Col-->
                           </div>
                        ...
                        <div class="fv-row mb-10">
                           <div class="row g-9 mb-7">
                              ...
                              <div class="col-md-3 fv-row">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="number" name="short_order" id="short_order" class="form-control mb-2 short_order" placeholder="Sort Order" value="" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Col-->
                           </div>
         ...
         <div class="d-flex justify-content-end">
            ...
            <!--end::Button-->
            <!--begin::Button-->
            <button type="submit" id="kt_add_purchaseworkscommittee_submit" class="btn btn-primary submit-purchaseworkscommittee-btn">
