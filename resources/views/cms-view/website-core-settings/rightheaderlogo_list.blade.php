...
@endsection
@section('breadcrumbs')
 {{ __('Right Header Logo Listing') }}
@endsection
@push('post-scripts')
<script src="{{ asset('public/js/header_right_logo_list_datatable.js') }}"></script>
@endpush
@section('content')
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_headerlogo" role="grid" aria-describedby="kt_datatable_info" style="width: 924px;">
            <thead>
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="kt_datatable_headerlogo" rowspan="1" colspan="1">{{__('Short Order')}}</th>
