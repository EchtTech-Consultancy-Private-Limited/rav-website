         ...
         <div class="tab-pane fade active show" id="Create_Menu" role="tabpanel" data-select2-id="select2-data-kt_ecommerce_settings_general">
            ...
            <form id="kt_settings_module_form" class="form" method="post">
               ...
               <div class="row fv-row mb-7">
                  ...
                  <div class="col-md-7">
                     <input type="text" class="form-control form-control-solid menuName_en" name="menuName_en" id="menuName_en" value="{{ $data->name_en ?? '' }}" />
                  </div>
               </div>
               <div class="row fv-row mb-7">
                  <div class="col-md-3 text-md-end">
                  ...
                  <div class="col-md-7">
                     <input type="text" class="form-control form-control-solid menuName_hi" name="menuName_hi" id="menuName_hi" value="{{ $data->name_hi ?? '' }}" />
                  </div>
               </div>
               <div class="row fv-row mb-7">
                  <div class="col-md-3 text-md-end">
                  ...
                  <div class="col-md-7">
                     <input type="text" class="form-control form-control-solid url" name="url" id="url" value="{{ $data->url ?? '' }}" />
                  </div>
               </div>
               <div class="row fv-row mb-7">
                  <div class="col-md-3 text-md-end">
                  ...
                  <div class="col-md-7">
                     <input type="number" class="form-control form-control-solid shortorder" name="shortorder" id="shortorder" value="{{ $data->sort_order ?? '' }}" />
                  </div>
               </div>
               <div class="row fv-row mb-7">
                  <div class="col-md-3 text-md-end">
                  ...
                  <div class="col-md-7">
                     <input type="text" class="form-control form-control-solid prefix" name="prefix" id="prefix" value="{{ $data->prefix ?? '' }}"  />
                  </div>
               </div>
               <div class="row py-5">
                  <div class="col-md-9 offset-md-3">
