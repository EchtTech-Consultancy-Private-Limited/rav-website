...
@endsection
@push('post-scripts')
<script src="{{ asset('public/form-js/home-page-sections-add.js') }}"></script>
@endpush
@section('content')
...
<div class="card card-flush">
   ...
   <!--begin::Card body-->
    <div class="card-body">
      <!--begin::Form-->
      <form id="kt_homepagesectiondesign_add_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
         <!--begin::Main column-->
         <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                 <label class="required form-label mw-100 w-100">Order Number</label>
                                    <input type="number" class="form-control mw-100 w-100 sort_order" name="sort_order" id="sort_order" placeholder="sort order"/>
                                </div>
                                <div class="col-md-6">
                                 <label class="form-label mw-100 w-100">Link (optional)</label>
                                    <input type="text" class="form-control mw-100 w-100 url_link" name="url_link" id="url_link" placeholder="https://..."/>
                                </div>
                            </div>
                                 <!--end::Input-->
                           </div>
            ...
            <div class="d-flex justify-content-end">
               ...
               <!--end::Button-->
               <!--begin::Button-->
               <button type="submit" id="kt_add_homepagesectiondesign_submit" class="btn btn-primary submit-homepagesectiondesign-btn">
