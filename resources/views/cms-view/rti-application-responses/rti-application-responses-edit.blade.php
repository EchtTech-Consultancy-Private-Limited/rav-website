...
@section('title')
    {{__('RTI Application Responses Edit')}}
@endsection
@section('pageTitle')
...
@endsection
@push('post-scripts')
<script src="{{ asset('public/form-js/rtiapplicationresponses-edit.js') }}"></script>
@endpush
@section('content')
...
<div id="kt_content_container" class="container-xxl">
   ...
   <div class="card-body">
   <!--begin::Form-->
   <form id="kt_rtiApplicationResponse_edit_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
      <!--begin::Main column-->
      <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="fv-row mb-10">
                           <div class="row g-9 mb-7">
                              ...
                              <div class="col-md-3 fv-row">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input class="form-control form-control-solid registration_number" type="text" placeholder="Registration Number" id="registration_number" name="registration_number" value="{{$data->registration_number}}" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Col-->
                              <!--begin::Col-->
                              <div class="col-md-3 fv-row">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input class="form-control form-control-solid" type="number" placeholder="Sort Order Number" name="short_order" value="{{$data->short_order}}" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Col-->
                           </div>
                        ...
                        <div class="fv-row mb-10">
                           <div class="row g-9 mb-7">
                              ...
                              <div class="col-md-6 fv-row">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" name="request_name_en" id="request_name_en" class="form-control mb-2 request_name_en" id="request_name_en" placeholder="Requester name" value="{{$data->request_name_en}}" />
                                 <!--end::Input-->
                              </div>
                              <div class="col-md-6 fv-row">
                                 <!--begin::Label-->
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" name="request_name_hi" id="request_name_hi" class="form-control mb-2 request_name_hi" id="request_name_hi" placeholder="अनुरोधकर्ता का नाम" value="{{$data->request_name_hi}}" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Col-->
                           </div>
                        ...
                        <div class="fv-row mb-10">
                           <div class="row g-9 mb-7">
                              ...
                              <div class="col-md-6 fv-row">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" name="pio_name_en" id="pio_name_en" class="form-control mb-2 pio_name_en" id="pio_name_en" placeholder="Requester name" value="{{$data->pio_name_en}}" />
                                 <!--end::Input-->
                              </div>
                              <div class="col-md-6 fv-row">
                                 <!--begin::Label-->
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" name="pio_name_hi" id="pio_name_hi" class="form-control mb-2 pio_name_hi" id="pio_name_en" placeholder="पीआईओ का नाम" value="{{$data->pio_name_en}}" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Col-->
                           </div>
         ...
         <div class="d-flex justify-content-end">
            ...
            <!--end::Button-->
            <!--begin::Button-->
            <button type="submit" id="kt_edit_rtiApplicationResponse_submit" class="btn btn-primary submit-rtiApplicationResponse-btn">
