         ...
         <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            <div class="d-flex flex-lg-row-fluid">
               <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                  <img class="theme-light-show mx-auto mw-100 w-150px w-lg-400px mb-10 mb-lg-20" src="{{ asset(config('constants.default.logo_image')) }}" alt=""/>    
                  <img class="theme-dark-show mx-auto mw-100 w-150px w-lg-400px mb-10 mb-lg-20" src="{{ asset(config('constants.default.logo_image')) }}" alt=""/>                 
