...
@endsection
@push('post-scripts')
<script src="{{ asset('public/form-js/private-gov-clients-add.js') }}"></script>
@endpush
@section('content')
...
<div class="card card-flush">
   ...
   <!--begin::Card body-->
    <div class="card-body">
      <!--begin::Form-->
      <form id="kt_pgcs_add_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
         <!--begin::Main column-->
         <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                              ...
                              <div class="row row-cols-1 row-cols-md-3 row-cols-lg-1 row-cols-xl-3 g-9" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button='true']">
                                 ...
                                 <div class="col">
                                    ...
                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6" data-kt-button="true">
                                       ...
                                       <input class="form-check-input" type="radio" name="tabtype" value="0" />
                                       </span>
                                       <!--end::Radio-->
                                       <!--begin::Info-->
                                       <span class="ms-5">
                                 ...
                                 <div class="col">
                                    ...
                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary active d-flex text-start p-6" data-kt-button="true">
                                       <!--begin::Radio-->
                                       <span class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                       <input class="form-check-input" type="radio" name="tabtype" value="1" checked="checked" />
                                       </span>
                                       <!--end::Radio-->
                                       <!--begin::Info-->
                                       <span class="ms-5">
                           ...
                           <div data-repeater-item class="form-group row">
                                ...
                                <div class="col-md-4">
                                 <label class="required form-label mw-100 w-100">Logo Title/Alt</label>
                                    <input type="text" class="form-control mw-100 w-100" name="title" placeholder="title Name" />
                                </div>
                                <div class="col-md-4">
            ...
            <div class="d-flex justify-content-end">
               ...
               <!--end::Button-->
               <!--begin::Button-->
               <button type="submit" id="kt_add_pgcs_submit" class="btn btn-primary submit-pgcs-btn">
