...
@endsection
@section('breadcrumbs')
 {{ __('Home Page Banner Edit') }}
@endsection
@push('post-scripts')
<script src="{{ asset('public/form-js/homepagebanner-edit.js') }}"></script>
@endpush
@section('content')
...
<div class="card card-flush">
   ...
   <div class="card-body">
      <!--begin::Form-->
      <form id="kt_banner_update_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
         <!--begin::Main column-->
         <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                           ...
                           <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                              ...
                              <div id="kt_tender_add_multiple_options">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <label class="required form-label mw-100 w-200px">Image Format ({{ env('BANNER_WIDTH').'px'??'1900px' }} * {{ env('BANNER_HEIGHT').'px'??'500px' }})</label>
                                    <div data-repeater-list="kt_tender_add_multiple_options" class="d-flex flex-column gap-3">
                                       <div data-repeater-item class="form-group d-flex flex-wrap align-items-center gap-5">
                                        ...
                                        <img src="{{ asset('resources/uploads/banner/'. $data->public_url)  }}" width="50px" />
                                          <!--end::Input-->
            ...
            <div class="d-flex justify-content-end">
               ...
               <!--end::Button-->
               <!--begin::Button-->
               <button type="submit" id="kt_update_banner_submit" class="btn btn-primary submit-banner-btn">
