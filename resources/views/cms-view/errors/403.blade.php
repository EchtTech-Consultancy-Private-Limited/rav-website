...
<div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{ asset('assets-cms/media/error/bg3.jpg') }});">
    ...
    <div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
        <h1 class="error-title font-weight-boldest text-info mt-10 mt-md-0 mb-12">403 | ACCESS FORBIDDEN</h1>
        <p class="font-weight-boldest display-4">You don't have permission to perform this action!</p>
