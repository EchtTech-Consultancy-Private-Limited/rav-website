...
<div class="card card-flush">
   ...
   <div class="card-body">
      <!--begin::Form-->
      <form id="kt_recentActivity_edit_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
         <!--begin::Main column-->
                     ...
                     <div class="card card-flush py-4">
                        ...
                        <div class="fv-row mb-10">
                           ...
                           <div class="mb-10 fv-row">
                              ...
                              <!--begin::Input-->
                              <div class="col-md-12">
                                 <input type="url" name="link" class="form-control mb-2 link" id="link" placeholder="http://" value="{{ $data->url_link }}" />
                              </div>
                              <!--end::Input-->
                           </div>
                           <!--begin::Input group-->
                           <div class="mb-10 fv-row">
                              ...
                              <!--begin::Input-->
                              <div class="col-md-12">
                                 <input type="text" name="title_name_en" class="form-control mb-2 title_name_en" id="title_name_en" placeholder="Title name" value="{{ $data->recent_activities_en }}" />
                              </div>
                              <!--end::Input-->
                              <!--begin::Description-->
                           ...
                           <div class="mb-10 fv-row mt-2">
                              ...
                              <!--begin::Input-->
                              <div class="col-md-12">
                                <input type="text" name="title_name_hi" class="form-control mb-2 title_name_hi" id="title_name_hi" placeholder="Title name" value="{{ $data->recent_activities_hi }}" />
                              </div>
                              <!--end::Input-->
                              <!--begin::Description-->
                              <div class="text-muted fs-7">A title name is required and recommended to be unique.</div>
