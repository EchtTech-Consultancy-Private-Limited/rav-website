                        ...
                        <div class="col-lg-3 col-md-3">
                            <ul class="nav nav-tabs" id="newsTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a title ="link" href="{{ url('/contact-us') }}" class="nav-link">Contact Us</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a title ="link" href="{{ url('/feedback') }}" class="nav-link active">Feedback</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a title ="link" href="{{ url('/terms-and-conditions') }}" class="nav-link "> Terms and
                                        Conditions</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a title ="link" href="{{ url('/sitemap') }}" class="nav-link"> Site Map</a>
                                </li>
