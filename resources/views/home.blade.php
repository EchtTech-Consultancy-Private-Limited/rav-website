        ...
        <div class="news-wrap">
            <div class="news-tab common-tab">
                <ul class="nav nav-tabs" id="newsTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation" tabindex="0">
                        <button class="nav-link" id="courses-tab" data-bs-toggle="tab"
                            data-bs-target="#courses-tab-pane" type="button" role="tab" aria-controls="courses-tab-pane"
                    ...
                    <li class="nav-item" role="presentation" tabindex="0">
                        <button class="nav-link" id="cme-tab" data-bs-toggle="tab" data-bs-target="#cme-tab-pane"
                            type="button" role="tab" aria-controls="cme-tab-pane" aria-selected="false" tabindex="0">
                            @if (Session::get('locale') == 'hi')
                ...
                <div class="tab-content pt-4 cme-schme-container" id="newsTabContent">
                    ...
                    <div class="tab-pane fade" id="cme-tab-pane" role="tabpanel" aria-labelledby="cme-tab" tabindex="0">
                        <div class="row">
                                    ...
                                    <div class="message-tab-img">
                                        <a href="#" class="video-wrap">
                                            <div class="video-img common-video-img" tabindex="0">
                                                ...
                                                '<img', '>' , );
                                                    $imgTag='<img class="video-img common-video-img img-fluid"' .
                                                    $imgTag; $imgTag=\Illuminate\Support\Str::before($imgTag, '>' )
                                                    . '>' ; @endphp {!! $imgTag !!} </div>
                                        </a>
                                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                <div class="our-journey-card my-md-0 my-2 ">
                    <img src="{{ $content->image_name }}" alt="{{ $content->image_name }}" class="img-fluid">
            ...
            <div class="col-md-3 mb-4">
                <div class="our-journey-card my-md-0 my-2">
                    <img src="{{ asset('assets/images/research.svg') }}" alt="research.svg" class="img-fluid" />
            ...
            <div class="col-md-3 mb-4">
                <div class="our-journey-card my-md-0 my-2">
                    <img src="{{ asset('assets/images/graduation.svg') }}" alt="graduation.svg" class="img-fluid" />
            ...
            <div class="col-md-3 mb-4">
                <div class="our-journey-card my-md-0 my-2">
                    <img src="{{ asset('assets/images/programme.svg') }}" alt="programme.svg" class="img-fluid" />
            ...
            <div class="col-md-3 mb-4">
                <div class="our-journey-card my-md-0 my-2">
                    <img src="{{ asset('assets/images/presence.svg') }}" alt="presence.svg" class="img-fluid" />
                                        ...
                                        <div class="row px-0">
                                            ...
                                            <div class="col-md-6">
                                                <div class="gallery-lbox video-sec new_gall_boxhead_change">
                                                    ...
                                                    <div class="btn-view_play">
                                                        <div class="btn-part  text-center">
                                                            <a class="readon2 mt-2" href="{{ url('/video-gallery') }}"
                                            ...
                                            <div class="plug-box twitter-feed-content p-2">
                                                <blockquote class="twitter-tweet">
                                                    <p lang="en" dir="ltr">In a step to mitigate the current
                                                        ...
                                                        <a href="https://t.co/IC6CoozxXn">pic.twitter.com/IC6CoozxXn</a>
