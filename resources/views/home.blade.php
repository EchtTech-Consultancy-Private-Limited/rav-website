                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6 mobile-width-30">
                        <div class="hero-slider-img" data-aos="fade-left" data-aos-duration="3000">
                           <img src="{{asset('assets/images/banner-image.png') }}" alt="hero-image" class="img-fluid">
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="col-md-6 mobile-width-80">
                        <div class="hero-slider-content" data-aos="fade-right" data-aos-duration="3000">
                           ...
                           <p class="title-black">
                              <span>Explore the Synergy</span>
                              of Rashtriya Ayurveda Vidyapeeth and Yoga for
                              Holistic Health! Many ancient works on Ayurvedic medicine are lost to posterity, but manuscripts of three principal early texts on Ayurveda have survived to the present day. These works are the Charaka Samhita, the Sushruta Samhita and the Bhela Samhita.  but manuscripts of three principal early texts on Ayurveda have survived to the present day. 
                           </p>
                           <div class="btn-wrap d-flex align-items-center">
                              <button class="btn btn-org me-4">
                              Know More
            ...
            <div class="col-md-9 p-0">
               <div class="latest-news-slider">
                  <div class="owl-carousel owl-theme" id="latest-news-slider">
                     <div class="item">
                        <p>Advertisement for the newly created posts of National Institute of Sowa-Rigpa, Leh</p>
                     </div>
                     <div class="item">
                        <p>Advertisement for CRAV Gurus for the session 2024-25</p>
                     </div>
                     <div class="item">
                        <p>SENSITIZATION - Quality Initiative for Ayurveda Training Courses</p>
                     </div>
                     <div class="item">
                        <p>5-day Training Program on Food, Functional Foods and Entrepreneurship Based on Ayurveda Aahara &amp; Regulatory Aspects</p>
                     </div>
                     <div class="item">
                        <p>Advertisement for the newly created posts of National Institute of Sowa-Rigpa, Leh</p>
                     </div>
            ...
            <div class="col-md-3">
               <div class="about-us-card mtb-100" data-aos="flip-right" data-aos-duration="3000">
                  ...
                  <div class="about-us-card-back">
                     ...
                     <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Beatae mollitia nostrum at dolorem optio ad ipsam suscipit harum molestias? Laudantium, ipsa! Molestiae reiciendis beatae, veniam cumque expedita rem at harum?</p>
                  </div>
               </div>
            </div>
            <div class="col-md-3">
                  ...
                  <div class="news-tab common-tab">
                     <ul class="nav nav-tabs" id="newsTab" role="tablist">
                        <li class="nav-item" role="presentation">
                           <button
                              ...
                              id="latestNews-tab"
                              data-bs-toggle="tab"
                              data-bs-target="#latestNews-tab-pane"
                              type="button"
                              role="tab"
                              aria-controls="latestNews-tab-pane"
                              aria-selected="true"
                              >Latest News</button>
                        </li>
                        <li class="nav-item" role="presentation">
                           <button
                              ...
                              type="button"
                              role="tab"
                              aria-controls="courses-tab-pane"
                              aria-selected="false"
                              >
                           Admission to
                           Courses
                        ...
                        <li class="nav-item" role="presentation">
                           <button
                              ...
                              id="cme-tab"
                              data-bs-toggle="tab"
                              data-bs-target="#cme-tab-pane"
                              type="button"
                              role="tab"
                              aria-controls="cme-tab-pane"
                              aria-selected="false"
                              >CME Scheme</button>
                        </li>
                     </ul>
                     <div class="tab-content pt-4" id="newsTabContent">
                        <div
                           ...
                           id="latestNews-tab-pane"
                           role="tabpanel"
                           aria-labelledby="latestNews-tab"
                           tabindex="0"
                           >
                           <div class="row">
                                 ...
                                 <ul>
                                    <li>
                                       <a href="#">
                                          ...
                                          <p class="desc">
                                             Advertisement for the newly created posts of National
                                             Institute of Sowa-Rigpa, Leh
                                          </p>
                                       </a>
                                    </li>
                                    <li>
                                       <a href="#">
                                          ...
                                          <p class="desc">
                                             Result of Young Professional held on Sep 04, 2023
                                          </p>
                                       </a>
                                    </li>
                                    <li>
                                       <a href="#">
                                          ...
                                          <p class="desc">
                                             Advertisement for CRAV Gurus for the session 2023-24
                                          </p>
                                       </a>
                                    </li>
                                    <li>
                                       <a href="#">
                                          ...
                                          <p class="desc">
                                             Two day clinical training programme on "Samhita based
                                             Clinical Diagnosis" for teachers at National institute of
                                             Ayurveda (NIA), Jaipur, Rajasthan during 21 -22 September,
                                             2023
                                          </p>
                                       </a>
                                    </li>
                           ...
                           <div class="row">
                              <div class="news-content-list">
                                 <div class="new-content-list-content">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href="http://ravdelhi.nic.in/sites/default/files/AYURGYAN-Scheme-CME-Guidelines-07.4.2021.pdf " target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href="http://ravdelhi.nic.in/sites/default/files/Hindi-AYURGYAN-Scheme-CME.pdf" target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href=" http://ravdelhi.nic.in/sites/default/files/AYUSH%20CME%20GUIDELINES.pdf" target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href=" http://ravdelhi.nic.in/sites/default/files/Upcoming%20CME%20program%202023-24%20%281%29%20%281%29.pdf" target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href=" http://www.ravdelhi.nic.in/en/circulars-orders-cme" target="_blank">
                                       Circulars/ Orders
                                       </a>
                                    </p>
                                    <p class="right-angle-arrow">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href="http://www.ravdelhi.nic.in/en/old-modules-ayurveda " target="_blank">
                                       Modules
                                       </a>
                                    </p>
                                    <p class="right-angle-arrow">
                                       <a href="{{asset('assets/pdf/home-page/cme-scheme/AYURGYAN-Scheme-CME-Guidelines-07.4.2021.pdf') }}" target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href="{{asset('assets/pdf/home-page/cme-scheme/Instruction%20for%20Air%20travel.pdf') }}" target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href="{{asset('assets/pdf/home-page/cme-scheme/CME%20Calendar%20for%202023-24%20%281%29.pdf') }} " target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href="{{asset('assets/pdf/home-page/cme-schem/CME%20Calendar%202022-23_%20.pdf') }}" target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href="./{{asset('assets/pdf/home-page/cme-schem/CME%20Calendar%20for%202021-22_0.pdf') }}" target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href="./{{asset('assets/pdf/home-page/cme-schem/CME%20Calender%202%20%202020-21.pdf') }} " target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href=" ./{{asset('assets/pdf/home-page/cme-schem/Calndar%20for%20CME%202019-20-converted.pdf') }}" target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href=" ./{{asset('assets/pdf/home-page/cme-schem/Calendar%20for%20CME%20%202018-19_2.pdf') }}" target="_blank">
                                    ...
                                    <p class="right-angle-arrow">
                                       <a href=" ./{{asset('assets/pdf/home-page/cme-schem/CME%20calender%20%2017-18.pdf') }}" target="_blank">
                        ...
                        <div class="item">
                           <div class="event-list">
                              ...
                              <div class="event-list-content my-3">
                                 ...
                                 <div class="date-wrap">
                                    <img src="{{asset('assets/images/calendar.svg') }}" alt="calendar" class="img-fluid me-3">
                                    <h3 class="date">
                                       8-9
                                       <span>June 2023</span>
                                    </h3>
                              ...
                              <div class="event-list-content my-3">
                                 ...
                                 <div class="address-wrap">
                                    <img src="{{asset('assets/images/location.svg') }}" alt="location" class="img-fluid me-3">
                                    <h3 class="address">
               ...
               <div class="message-tab common-tab">
                  <ul class="nav nav-tabs" id="messageTab" role="tablist">
                     <li class="nav-item" role="presentation">
                        <button
                           class="nav-link active"
                           id="latestMassage-tab"
                           data-bs-toggle="tab"
                           data-bs-target="#latestMassage-tab-pane"
                           type="button"
                           role="tab"
                           aria-controls="latestMassage-tab-pane"
                           aria-selected="true"
                           >Latest Massage</button>
                     </li>
                     <li class="nav-item" role="presentation">
                        <button
                           class="nav-link"
                           id="ourMinisters-tab"
                           data-bs-toggle="tab"
                           data-bs-target="#ourMinisters-tab-pane"
                           type="button"
                           role="tab"
                           aria-controls="ourMinisters-tab-pane"
                           aria-selected="false"
                           >
                        Meet Our
                        Ministers
                     ...
                     <li class="nav-item" role="presentation">
                        <button
                           ...
                           id="corner-tab"
                           data-bs-toggle="tab"
                           data-bs-target="#corner-tab-pane"
                           type="button"
                           role="tab"
                           aria-controls="corner-tab-pane"
                           aria-selected="false"
                           >Alumni Corner</button>
                     </li>
                     <li class="nav-item" role="presentation">
                        <button
                           class="nav-link"
                           id="tenders-tab"
                           data-bs-toggle="tab"
                           data-bs-target="#tenders-tab-pane"
                           type="button"
                           role="tab"
                           aria-controls="tenders-tab-pane"
                           aria-selected="false"
                           >Our Tenders</button>
                     </li>
                     <li class="nav-item" role="presentation">
                  ...
                  <div class="tab-content pt-3" id="messageTabContent">
                     <div
                        class="tab-pane fade show active"
                        id="latestMassage-tab-pane"
                        role="tabpanel"
                        aria-labelledby="latestMassage-tab"
                        tabindex="0"
                        >
                        <div class="row">
                           <div class="col-md-4">
                              <div class="message-tab-img">
                                 <a href="#" class="video-wrap">
                                    <div class="video-img common-video-img">
                                       <img src="{{asset('assets/images/massage.png') }}" alt="video" class="img-fluid">
                                    </div>
                                 </a>
                              </div>
                           </div>
                     ...
                     <div
                        class="tab-pane fade"
                        id="ourMinisters-tab-pane"
                        role="tabpanel"
                        aria-labelledby="ourMinisters-tab"
                        tabindex="0"
                        >
                        <div class="row">
                           <div class="col-md-4">
                              <div class="message-tab-img">
                                 <a href="#" class="video-wrap">
                                    <div class="video-img common-video-img">
                                       <img src="{{asset('assets/images/sarbanada-sonowal.jpg') }}" alt="video" class="img-fluid">
                                    </div>
                                 </a>
                              </div>
                           </div>
                                 ...
                                 <table>
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:mrpankaj8982pat@gmail.com">mrpankaj8982pat@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:abhiranjankumar85@gmail.com">abhiranjankumar85@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:doc.ms.eleven@gmail.com">doc.ms.eleven@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:ranapooja947@gmail.com">ranapooja947@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:vandanagarg874@gmail.com">vandanagarg874@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:drkailashkumar9680@gmail.com">drkailashkumar9680@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:Anjalinagpal325@gmail.com">Anjalinagpal325@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:tanvisharma0292@gmail.com">tanvisharma0292@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:chandara528@gmail.com">chandara528@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:drajaychauhan2529@gmail.com">drajaychauhan2529@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:atulagaur.ap@gmail.com">atulagaur.ap@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:Pchokhandre03@gmail.com">Pchokhandre03@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:rashmimotegaonkar7@gmail.com">rashmimotegaonkar7@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:snehasuresan@gmail.com">snehasuresan@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:dkverma7791@gmail.com">dkverma7791@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:drrajpalsinghdhaka@gmail.com">drrajpalsinghdhaka@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:vinayakdadu92@gmail.com">vinayakdadu92@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:drmukeshkumarsagar@gmail.com">drmukeshkumarsagar@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:drmksablania@gmail.com">drmksablania@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:saranrajmg2013@gmail.com">saranrajmg2013@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:jeetmalviwa11@gmail.com">jeetmalviwa11@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:drbrajmalviya@gmail.com">drbrajmalviya@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:varshajajewal96@gmail.com">varshajajewal96@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:shubhamshandilya25@gmail.com">shubhamshandilya25@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:verma.manu786@gmail.com">verma.manu786@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:aakanksha3455@gmail.com">aakanksha3455@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:sisodiyakamal32@gmail.com">sisodiyakamal32@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:sharma07meha@gmail.com">sharma07meha@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:drrsmeena89@gmail.com">drrsmeena89@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:sumayyamumina9@gmail.com">sumayyamumina9@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:Nitinranakoti@gmail.com">Nitinranakoti@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:kathirkarthi96@gmail.com">kathirkarthi96@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:dr.viveksinghrajavat@gmail.com">dr.viveksinghrajavat@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:drprernarkp@gmail.com">drprernarkp@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:ritikakaswa830@gmail.com">ritikakaswa830@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:pushpen7232@gmail.com">pushpen7232@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:surbhiagrawal1096@gmail.com">surbhiagrawal1096@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:Parulkalia7174@gmail.com">Parulkalia7174@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:Sand3456739@gmail.com">Sand3456739@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:rajputpraveen1966@gmail.com">rajputpraveen1966@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:himanshuupadhyay123@gmail.com">himanshuupadhyay123@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:manishpushker@gmail.com">manishpushker@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:bairwamanu1@gmail.com">bairwamanu1@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:kmkarthika93@gmail.com">kmkarthika93@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:drpoojavasure@gmail.com">drpoojavasure@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:snehalatabharti2321@gmail.com">snehalatabharti2321@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:doctoranil3489@gmail.com">doctoranil3489@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:chandara57.cp@gmail.com">chandara57.cp@gmail.com</a>
                                          </td>
                                          <td>
                                             Village Gudha khurd, Via Palsana, Dist. Sikar, Rajasthan
                                             332402
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:divyadhurvey707@gmail.com">divyadhurvey707@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="http://manishapraj9gmail.com/">manishapraj9gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:drakashkumar1991@gmail.com">drakashkumar1991@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:pratibha.ramola93@gmail.com">pratibha.ramola93@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:anjali03rajput@gmail.com">anjali03rajput@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:rahar.anjaly@gmail.com">rahar.anjaly@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:phoolchandraprajapati1276@gmail.com">phoolchandraprajapati1276@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:lakhantrivedi9793@gmail.com">lakhantrivedi9793@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:kalalhemendra38@gmail.com">kalalhemendra38@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:bhargavatarun44@gmail.com">bhargavatarun44@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:hardikdesai370@gmail.com">hardikdesai370@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:gautamatul90@gmail.com">gautamatul90@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:drmanjeetrawat12@gmail.com">drmanjeetrawat12@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:dr.ashokprajapat@gmail.com">dr.ashokprajapat@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:shvetasharma8094@gmail.com">shvetasharma8094@gmail.com</a>
                                          </td>
                                          <td>
                                             VPO.DORAI
                                             <br>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:dr.savani94@gmail.com">dr.savani94@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:kamayanimaurya1998@gmail.com">kamayanimaurya1998@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:palakporwal54@gmail.com">palakporwal54@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:kamleshsingaria@gmail.com">kamleshsingaria@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:mangi.mangi120@gmail.com">mangi.mangi120@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:meetpatel1509@gmail.com">meetpatel1509@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:ahamad.shoaib1987@gmail.com">ahamad.shoaib1987@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:anseelakadher19@gmail.com">anseelakadher19@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:raghavdiwan015@gmail.com">raghavdiwan015@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:khansheeba.sk65@gmail.com">khansheeba.sk65@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:aswathyekm007@gmail.com">aswathyekm007@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:attarialimubarak315@gmail.com">attarialimubarak315@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:anoopshrivastava98@gmail.com">anoopshrivastava98@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:vaidyaanjalisharma@gmail.com">vaidyaanjalisharma@gmail.com</a>
                                          </td>
                                          <td>New Delhi</td>
                                          <td>2019</td>
                                          <td>Kaya chikitsa</td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:VIKASMUKATI66@GMAIL.COM">VIKASMUKATI66@GMAIL.COM</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:betsyvarghese2017@gmail.com">betsyvarghese2017@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:dipajain4114@gmail.com">dipajain4114@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:dr.amrutakalaskar@gmail.com">dr.amrutakalaskar@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:dr.varshakuniyal@gmail.com">dr.varshakuniyal@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:jogendra.Chauhan.2012@gmail.com">jogendra.Chauhan.2012@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:srojghosliya@gmail.com">srojghosliya@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:Alok.kushawaha92@gmail.com">Alok.kushawaha92@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:Meemansagaur09@gmail.com">Meemansagaur09@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:rup.rawat11@gmail.com">rup.rawat11@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:drruchikachoudhary@gmail.com">drruchikachoudhary@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:priyankaramola07@gmail.com">priyankaramola07@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:renuswamibaj@gmail.com">renuswamibaj@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:drrameshahs@gmail.com">drrameshahs@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:Deepikagusain42@gmail.com">Deepikagusain42@gmail.com</a>
                                          </td>
                                          <td>Dehradun</td>
                                          <td>2021</td>
                                          <td>Kayachiktsha</td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:deepakwarrier4401@gmail.com">deepakwarrier4401@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:honeychindu14@gmail.com">honeychindu14@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:kaushsaini84@gmail.com">kaushsaini84@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:shaisanassim33@gmail.com">shaisanassim33@gmail.com</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:KALPATARUAYURVEDA99@GMAIL.COM">KALPATARUAYURVEDA99@GMAIL.COM</a>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Male</td>
                                          <td>
                                             <a href="mailto:tailorprateek@gmail.com">tailorprateek@gmail.com</a>
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          <td>Female</td>
                                          <td>
                                             <a href="mailto:shilpa291295@gmail.com">shilpa291295@gmail.com</a>
                                          </td>
                     ...
                     <div
                        ...
                        <div class="row">
                           <div class="text-content">
                              ...
                              <ol>
                                 <li>
                                    <a href="{{asset('assets/pdf/home-page/rti-act.pdf') }}" target="_blank">Right To Information Act, 2005[PDF](810.29 KB).</a>
                                 </li>
                                 <li>
                  ...
                  <ul class="nav nav-tabs" id="activityTab" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                        <button
                           ...
                           id="crav-tab"
                           data-bs-toggle="tab"
                           data-bs-target="#crav-tab-pane"
                           type="button"
                           role="tab"
                           aria-controls="crav-tab-pane"
                           aria-selected="false"
                           >CRAV Gurus</button>
                     </li>
                  </ul>
                                    ...
                                    <div class="row m-0">
                                       <div class="col-md-6 p-0">
                                          <div class="activity-slider-img">
                                             <img src="{{asset('assets/images/activity-slider1.png') }}" alt="activity-slider1" class="img-fluid">
                                          </div>
                                       </div>
                                       <div class="col-md-6 p-0">
                                          <div class="activity-slider-content">
                                             ...
                                             <a href="#" class="read-more">
                                             <img src="{{asset('assets/images/read-more.svg') }}" alt="read-more" class="img-fluid">
                                             </a>
                                          </div>
                                       </div>
                                    </div>
                              ...
                              <div class="item">
                                 <div class="activity-slider-card">
                                    <div class="row m-0">
                                       <div class="col-md-6 p-0">
                                          <div class="activity-slider-img">
                                             <img src="{{asset('assets/images/activity-slider2.png') }}" alt="activity-slider1" class="img-fluid">
                                          </div>
                                       </div>
                                       <div class="col-md-6 p-0">
                                          <div class="activity-slider-content">
                              ...
                              <div class="item">
                                 <div class="activity-slider-card">
                                    <div class="row m-0">
                                       <div class="col-md-6 p-0">
                                          <div class="activity-slider-img">
                                             <img src="{{asset('assets/images/activity-slider3.png') }}" alt="activity-slider1" class="img-fluid">
                                          </div>
                                       </div>
                                       <div class="col-md-6 p-0">
                                          <div class="activity-slider-content">
                  ...
                  <ul class="nav nav-tabs" id="photoTab" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                        <button
                           ...
                           id="photo-tab"
                           data-bs-toggle="tab"
                           data-bs-target="#photo-tab-pane"
                           type="button"
                           role="tab"
                           aria-controls="photo-tab-pane"
                           aria-selected="true"
                           >Our Photos</button>
                     </li>
                     <li class="nav-item" role="presentation">
                        ...
                        <div class="photo-gallery-wrap">
                           <div class="row">
                              <div class="col-md-4">
                                 ...
                                 <div class="photo-gallery-img">
                                    <img src="{{asset('assets/images/photo2.png') }}" alt="photo" class="img-fluid">
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="photo-gallery-img">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="photo-gallery-img">
                                    <img src="{{asset('assets/images/photo5.png') }}" alt="photo" class="img-fluid">
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <div class="col-md-12">
               <div class="client-slider">
                  <div class="owl-carousel owl-theme" id="clientSlider">
                     ...
                     <div class="item">
                        <a href="#" class="client-slider-img">
                        <img src="{{asset('assets/images/digital-india.svg') }}" alt="digital-india" class="img-fluid">
                        </a>
                     </div>
                     <div class="item">
                        <a href="#" class="client-slider-img">
                        <img src="{{asset('assets/images/ministry-of-ayush.svg') }}" alt="ministry-of-ayush" class="img-fluid">
                        </a>
                     </div>
                     <div class="item">
                        <a href="#" class="client-slider-img">
