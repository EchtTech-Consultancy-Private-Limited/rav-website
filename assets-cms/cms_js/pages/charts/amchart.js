...
function barChartWithImg() {
  ...
  chart.data = [{
    ...
    "bullet": "../../assets-cms/images/user/user1-round.png"
  }, {
    "name": "Damon",
    "points": 65456,
    "color": chart.colors.next(),
    "bullet": "../../assets-cms/images/user/user2-round.png"
  }, {
    "name": "Patrick",
    "points": 45724,
    "color": chart.colors.next(),
    "bullet": "../../assets-cms/images/user/user3-round.png"
  }, {
    "name": "Sarah",
    "points": 13654,
    "color": chart.colors.next(),
    "bullet": "../../assets-cms/images/user/user4-round.png"
  },
  {
    "name": "Pooja",
    "points": 32589,
    "color": chart.colors.next(),
    "bullet": "../../assets-cms/images/user/user5-round.png"
  },
  {
    "name": "jatin",
    "points": 45895,
    "color": chart.colors.next(),
    "bullet": "../../assets-cms/images/user/user6-round.png"
  },
  ];
